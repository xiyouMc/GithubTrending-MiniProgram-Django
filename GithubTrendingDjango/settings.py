"""
Django settings for GithubTrendingDjango project.
...
header = {'Authorization': ' token ' + github_token.token}
...
GITHUB_LOGIN_DEFAULT = 'https://github.com/login'
...
ROOT_URLCONF = 'GithubTrendingDjango.urls'
...
WSGI_APPLICATION = 'GithubTrendingDjango.wsgi.application'
